...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'My Tax Accounting — small business accounting: GST, payroll, annual accounts, and tax returns.',
}
      ...
      <Section background='gray'>
        <Container>
          <div className='max-w-3xl mx-auto text-center'>
            <h1 className='text-4xl md:text-5xl font-bold text-gray-900 mb-6'>About My Tax Accounting</h1>
        ...
        <Container>
          <div className='max-w-4xl mx-auto'>
            <div className='prose prose-lg mx-auto'>
              ...
              <p className='text-gray-600 mb-8 text-lg'>Make clear, compliant accounting accessible to every SME with fixed monthly fees.</p>
              ...
              <p className='text-gray-600 mb-8'>We combine modern software with experienced accountants to deliver on‑time compliance and clear financials. Fixed‑fee packages keep costs predictable for SMEs.</p>
            </div>
          </div>
        </Container>
      </Section>
      ...
      <Section background='dark'>
        <Container>
          <div className='text-center max-w-3xl mx-auto'>
            <h2 className='text-3xl font-bold text-white mb-4'>Ready to Operate Clean?</h2>
            <p className='text-xl text-gray-300 mb-8'>Experience the My Tax Accounting difference for yourself.</p>
