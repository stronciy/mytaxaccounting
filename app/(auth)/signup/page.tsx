  ...
  return (
    <div>
      ...
      <form className='space-y-4'>
        ...
        <div className='flex items-start gap-2'>
          ...
          <label htmlFor='terms' className='text-sm text-gray-600'>
            I agree to the <Link href='/terms' className='text-[#0066CC] hover:underline'>Terms of Service</Link> and <Link href='/privacy' className='text-[#0066CC] hover:underline'>Privacy Policy</Link>
          </label>
        </div>
      ...
      <p className='text-center mt-6 text-sm text-gray-600'>
        Already have an account? <Link href='/login' className='text-[#0066CC] hover:underline font-medium'>Log in</Link>
      </p>
    </div>
  )
}
